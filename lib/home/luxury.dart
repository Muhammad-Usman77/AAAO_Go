...
class LuxuryCarPage extends StatefulWidget {
  const LuxuryCarPage({super.key});

  @override
  State<LuxuryCarPage> createState() => _LuxuryCarPageState();
}

class _LuxuryCarPageState extends State<LuxuryCarPage> {
  List<String> images = [
    'assets/byke.png',
    'assets/car2.png',
    'assets/car2.png',
